...
<div class="section-fix">
    <h2 class="page-title"><asp:Label ID="lblMenuTitle" runat="server" Text="인사말" meta:resourcekey="lblMenuTitle" />
        <!-- 모바일 뒤로 가기 -->
        <span class="goback">
    ...
    <section class="greeting sub-design block">
        <figure>
            <img src="/asset/images/sub/greeting.jpg" alt="시뮬레이션룸 사진">
        </figure>
        <div class="greeting-cont">
            <p class="headline">
                Global Ocean Leader Training Center<br>
                Your Best HRD Partner! G-MARINE ACADEMY
            </p>
            <p>
                고품질 해운 서비스의 지속적인 창출은 우수한 해기역량을 보유한 승무원에 의해서만 가능합니다.
                체계화된 실무 중심의 교육훈련으로 핵심 해기역량을 보유한 승무원이야 말로 선박과 인명의 안전, 그리고 소중한 고객의 화물을 위험으로 부터 지켜내는 안전운항의 원동력입니다.<br><br>
                이러한 해기역량을 갖춘 인재 확보는 지속 가능 경영의 초석이 되어, 우리 미래를 굳건히 받쳐 줄 것입니다.
