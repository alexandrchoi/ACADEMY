<%@ Page Language="C#" MasterPageFile="/MasterWin.Master" AutoEventWireup="true" CodeBehind="codedetail_edit.aspx.cs" Inherits="CLT.WEB.UI.LMS.MANAGE.codedetail_edit" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHead" runat="Server">
    ...
    function fnValidateForm()
    {
        ...
        // 길이체크
        if(isMaxLenth(document.getElementById('<%=txtMasterCode.ClientID %>'),6,'<%=CLT.WEB.UI.COMMON.BASE.MsgInfo.GetMsg("A007", new string[] { lblMasterCode.Text,"6" }, new string[] { lblMasterCode.Text,"6" }, System.Threading.Thread.CurrentThread.CurrentCulture) %>')) return false;
