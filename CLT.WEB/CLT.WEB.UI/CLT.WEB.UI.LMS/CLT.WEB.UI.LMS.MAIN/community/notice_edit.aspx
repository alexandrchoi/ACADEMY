            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        &nbsp; &nbsp;
                        <a style="font-size: medium; font-weight: bold;" href="#" onclick="saveMenuCD('2', '2', '0', '/manage/codedetail_list.aspx?openerEditMode=m_cd_edit&openerm_cd=0061');">☜ MASTER CODE :  0061</a>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                ...
                <tr>
                    <th scope="row" rowspan="2">
                        <asp:Label ID="lblAttach" runat="server" Text="첨부파일" meta:resourcekey="lblAttach" />
