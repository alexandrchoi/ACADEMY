    ...
    <section class="section-board">
        ...
        <div class="search-box">
            ...
            <div class="search-group">
                ...
                <a href="#" class="button-board-search" onclick="openPopWindow('/common/course_pop.aspx?opener_textbox_id=<%=HiddenCourseID.ClientID%>&opener_textbox_nm=<%=HiddenCourseNM.ClientID %>&MenuCode=<%=Session["MENU_CODE"]%>', 'course_pop', '600', '650');"></a>
            </div>
            <div class="search-group">
