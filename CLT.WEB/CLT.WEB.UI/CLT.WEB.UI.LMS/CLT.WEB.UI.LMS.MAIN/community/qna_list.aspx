<%@ Page Language="C#" MasterPageFile="/MasterSub.Master" AutoEventWireup="true" CodeBehind="qna_list.aspx.cs" Inherits="CLT.WEB.UI.LMS.COMMUNITY.qna_list" 
            ...
            <C1WebGrid:C1WebGrid ID="C1WebGrid1" AllowSorting="True" AllowColSizing="True" runat="server" AutoGenerateColumns="false" OnItemDataBound="C1WebGrid1_ItemDataBound" DataKeyField="boa_no" OnItemCreated="grd_ItemCreated">
                <Columns>
                    ...
                    <C1WebGrid:C1TemplateColumn HeaderText="제목">
                        <ItemTemplate>
                                <a id="boa_sub" href="/community/qna_detail.aspx?seq=<%# DataBinder.Eval(Container.DataItem, "boa_no")%>&MenuCode=<%=Session["MENU_CODE"]%>"><%# DataBinder.Eval(Container.DataItem, "boa_sub")%></a>
                            <span class="cmt-amount"><%# DataBinder.Eval(Container.DataItem, "boa_count")%></span>
                        </ItemTemplate>
