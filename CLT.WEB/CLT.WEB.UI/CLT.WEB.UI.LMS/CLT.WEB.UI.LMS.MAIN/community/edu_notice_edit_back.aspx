<%@ Page Language="C#" MasterPageFile="/MasterSub.Master" AutoEventWireup="true" CodeBehind="edu_notice_edit.aspx.cs" Inherits="CLT.WEB.UI.LMS.COMMUNITY.edu_notice_edit"
        ...
        <div class="board-list gm-table data-table read-type">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txtCus_ID" ReadOnly="True" runat="server" width="120px"/>
                        <asp:TextBox ID="txtCus_NM" ReadOnly="True" runat="server" width="120px" />
                ...
                <tr>
                    ...
                    <td colspan="2" width="85%">
                        <asp:TextBox ID="txtNotice_From" runat="server" CssClass="datepick" width="120px" />
                        <span class="gm-text2">~</span>
                        <asp:TextBox ID="txtNotice_To" runat="server" CssClass="datepick" width="120px" />
                ...
                <tr>
                    ...
                    <td class="file" colspan="2" >
                        ...
                        <asp:Button ID="btnUpload" CssClass="button-icon plus" OnClick="btnUpload_OnClick" Text="Add" runat="server" meta:resourcekey="btnUploadResource" />
                        <asp:Button ID="btnRemove" CssClass="button-icon ex" Text="Remove" OnClick="btnRemove_OnClick" runat="server" meta:resourcekey="btnRemoveResource" />
                    </td>
                </tr>
                <tr>
