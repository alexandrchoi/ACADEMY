<%@ Page Language="C#" MasterPageFile="/MasterSub.Master" AutoEventWireup="true" CodeBehind="notice_list.aspx.cs" Inherits="CLT.WEB.UI.LMS.COMMUNITY.notice_list" 
            ...
            <C1WebGrid:C1WebGrid ID="C1WebGrid1" AllowSorting="True" AllowColSizing="True" runat="server" AutoGenerateColumns="false" OnItemDataBound="C1WebGrid1_ItemDataBound" DataKeyField="not_no" OnItemCreated="grd_ItemCreated">
                <Columns>
                    ...
                    <C1WebGrid:C1TemplateColumn HeaderText="제목">
                        <ItemTemplate>
                            <a id="not_sub" href="/community/notice_detail.aspx?rseq=<%# DataBinder.Eval(Container.DataItem, "not_no")%>&MenuCode=<%=Session["MENU_CODE"]%>&delYN=<%=ddlDelYn.SelectedValue %>"><%# DataBinder.Eval(Container.DataItem, "not_sub")%></a>
                        </ItemTemplate>
