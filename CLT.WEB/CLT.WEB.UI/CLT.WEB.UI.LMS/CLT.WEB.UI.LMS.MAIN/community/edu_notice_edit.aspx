                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <input type="button" id="btnCus_Search" value="Search" class="button-default blue"
                            onclick="setWebControls();openPopWindow('/common/course_pop.aspx?opener_textbox_id=<%=HiddenCourseID.ClientID%>&opener_textbox_nm=<%=HiddenCourseNM.ClientID %>', 'course_pop_win', '600', '650');" />
                    </td>
                </tr>
                <tr>
                    <th scope="row">
