<%@ Page Language="C#" MasterPageFile="/MasterSub.Master" AutoEventWireup="true" CodeBehind="edu_notice_detail.aspx.cs" Inherits="CLT.WEB.UI.LMS.COMMUNITY.edu_notice_detail" 
...
<div class="section-fix">
    ...
    <section class="section-board">
        ...
        <div class="button-box right">
            ...
            <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="button-default" OnClick="button_Click" Visible="False" meta:resourcekey="btnDeleteResource" /><!-- OnClientClick="return confirm(deletemsg);"-->
