<%@ Page Language="C#" MasterPageFile="/MasterWin.Master" AutoEventWireup="true" CodeBehind="opencourse_pop.aspx.cs" Inherits="CLT.WEB.UI.LMS.COMMON.opencourse_pop" 
    ...
    <section class="section-board">
        ...
        <div class="gm-table plane-table">
            <table>
                ...
                <tbody>
                <tr>
                    <th scope="col"><asp:Label ID="lblCourseYear" runat="server" meta:resourcekey="lblCourseYear" /></th>
                    <td><asp:DropDownList ID="ddlCourseYear" runat="server" /></td>
                ...
                <tr>
                    <th scope="col"><asp:Label ID="lblCourseBeginPeriod" runat="server" meta:resourcekey="lblCourseBeginPeriod" /></th>
                    <td colspan="3">
                        <asp:TextBox runat="server" ID="txtBeginDt" MaxLength="10" CssClass="datepick" />
                        &nbsp;~&nbsp;
                        <asp:TextBox runat="server" ID="txtEndDt" MaxLength="10" CssClass="datepick" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
        ...
        <div class="gm-table data-table read-type">
            <C1WebGrid:C1WebGrid ID="C1WebGrid1" runat="server" AllowSorting="True" AllowColSizing="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <C1WebGrid:C1TemplateColumn >
                        <ItemTemplate>
                            <a href="#" onclick="setTextValOfOpener1(self, opener, '<%=ViewState["opener_textbox_id"].ToString() %>', '<%# DataBinder.Eval(Container.DataItem, "course_id")%>', '<%=ViewState["opener_textbox_nm"].ToString() %>', '<%# DataBinder.Eval(Container.DataItem, "course_nm")%>');opener.__doPostBack('ctl00$ContentPlaceHolderMain$btnSelect','');">
                    ...
                    <C1WebGrid:C1TemplateColumn >
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "course_begin_dt", "{0:yyyy.MM.dd}")%> ~ <%# DataBinder.Eval(Container.DataItem, "course_end_dt", "{0:yyyy.MM.dd}")%>
                        </ItemTemplate>
                        <ItemStyle Width="30%" HorizontalAlign="Center"  />
                    </C1WebGrid:C1TemplateColumn>
