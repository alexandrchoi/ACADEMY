<%@ Page Language="C#" MasterPageFile="/MasterSub.Master" AutoEventWireup="true" CodeBehind="join_user_agree.aspx.cs" Inherits="CLT.WEB.UI.LMS.MYPAGE.join_user_agree" 
    ...
    <script type="text/javascript" language="javascript">
		function GoJoinForm()
        {
            if (!document.getElementById("agree_chk").checked) {
                ...
                document.location.href="join_user_reg.aspx";
            }
            return true;
        }
            ...
            <div class="agree-box">
                ...
                <div class="message-box white box-hide-y">
                    ...
                    <ol class="list-order-sm">
                        ...
                        <li>회원에 가입하여 서비스를 이용하고자 하는 희망자는 지마린아카데미에서 요청하는 개인 신상정보를 제공해야 합니다.</li>
                ...
                <div class="agree right">
                    <label class="checkbox-box"><span>[필수] 이용약관에 동의합니다.</span>
                ...
                <div class="message-box white box-hide-y">
                    <ol class="list-order">
                        ...
                        <li>수집•이용하려는 개인정보의 항목
                            <ul class="dash-list">
                                <li>필수 : 아이디, 비밀번호, 성명(한글), 성명(영문), 생년월일, 회사명, 부서, 직급, 주소, 휴대폰, 이메일, 문자 수신여부</li>
                                <li>선택 : 전화번호, 고용보험취득일, 증명사진업로드</li>
                            </ul>
                        </li>
                        <li>개인정보의 보유 및 이용 기간
                            <ul class="dash-list">
                    ...
                    <div class="gm-table data-table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="center">교육비 고용보험 환급</td>
                            ...
                            <tr>
                                <td class="center">강사정보</td>
                                <td class="center">직업능력 심사평가원(HRD-net)</td>
                                <td class="center">근로자직업능력개발법</td>
                                <td class="center">정부위탁사업(강사자격심의)</td>
                                <td class="center">성명, 주민등록번호, 교육과정, 전화번호, 이메일, 출결현황 등</td>
                                <td class="center">3년</td>
                            </tr>
                            <tr>
                                ...
                                <td class="center">한국고용정보원(HRD-net)</td>
                                <td class="center">근로자직업능력개발법</td>
                                <td class="center">정부위탁사업(근로자 비용지원)</td>
                                <td class="center">성명, 주민등록번호, 전화번호, 이메일, 소속, 학위, 경력, 자격, 계좌번호 등</td>
                                <td class="center">3년</td>
                            </tr>
                            <tr>
                                <td class="center">강사정보</td>
